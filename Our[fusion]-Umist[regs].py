...
def test_face(Img, Label, CAE, num_class, reg1, reg2, reg3):    
    ...
    print("\nreg1:",reg1, "reg2:",reg2, "reg3:",reg3, file=file_out)
        ...
        for reg1 in reg1s:
            for reg2 in reg2s:
                for reg3 in reg3s:
                    ...
                    avg_i, med_i = test_face(Img, Label, CAE, num_class, reg1, reg2, reg3)
                    avg.append(avg_i)
                    med.append(med_i)
